"""
Film İzleme Sayacı - Geliştirilmiş İnteraktif Film Önerme Uygulaması

Bu uygulama kullanıcıdan film seçimlerini alır ve sürekli öğrenerek
daha iyi öneriler sunar. Gelişmiş özellikler içerir.
"""
...
def main():
    """Ana fonksiyon"""
    app = InteractiveMovieRecommender('processed_tmdb_movies.csv')
    app.run()
